    ...
    <aside className="hidden md:block w-64 bg-white border-r">
      <nav className="p-4">
        <div className="space-y-2">
          <Link
            href="/dashboard"
            className="flex items-center px-3 py-2 text-sm font-medium rounded-md text-[#665CF0] hover:bg-gray-50 relative group"
          >
            <svg className="mr-3 h-5 w-5 text-[#665CF0]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            Dashboard
            <span className="absolute left-0 w-1 h-5 bg-[#E6FF02] opacity-0 group-hover:opacity-100 transition-opacity"></span>
          </Link>
          <Link
            href="/listings"
            className="flex items-center px-3 py-2 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-50 hover:text-[#665CF0] relative group"
          >
